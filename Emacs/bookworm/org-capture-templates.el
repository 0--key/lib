...
(setq org-capture-templates
	...
	("t" "Todo" entry (file+headline
			   "~/Git/0--key/lib/org/agenda/might-do.list" "Tasks")
	 "* RAW %?%i\n \n %a")
	;;
	("i" "Idiom" entry (file+headline
			    "~/Git/0--key/lib/org/drills.org" "Idioms")
	 "* COMMENT >->->:drill:\n%i")
	;;
	("p" "Proverb" entry (file+headline
			      "~/Git/0--key/lib/org/drills.org" "Proverbs")
	 "** COMMENT ==> => >> :drill:
   :PROPERTIES:
   ...
   :END:\n%?%i\n\n" :empty-lines 1)
	...
	("w" "Quote" entry (file+headline
			    "~/Git/0--key/lib/org/drills.org" "Quotes")
	 "* COMMENT >->-> %c :drill:
   :PROPERTIES:
   :DRILL_CARD_TYPE: hide1cloze
   :END:\n%?%i\n")
   ...
   :END:\n%?%i\n\n" :empty-lines 1)
	...
	("h" "Thank You" entry (file+headline
				"~/Git/0--key/lib/org/drills.org" "How to say 'Thank You!'")
	 "** COMMENT ==> => >> :drill:
   :PROPERTIES:
   :DRILL_CARD_TYPE: hide1cloze
   :END:\n%?%i\n\n" :empty-lines 1)
