...
class fratellistrazzullo_spider(BaseSpider):
    ...
    def __init__(self, *a, **kw):
        super(fratellistrazzullo_spider, self).__init__(*a, **kw)
    ...
    def parse(self, response):
        ...
        for i in range(1, self.pages_count + 1):
            url = "http://stores.ebay.it/fratellistrazzullo/_i.html?_pgn=" + str(i)
