...
class caldaiemurali_spider(BaseSpider):
    name = 'caldaiemurali-it.ebay'
    allowed_domains = ['www.ebay.it', 'stores.ebay.it', 'ebay.it', 'ebay.com']
    start_urls = ('http://stores.ebay.it/caldaiemurali-it',)
    ...
    def __init__(self, *a, **kw):
        super(caldaiemurali_spider, self).__init__(*a, **kw)
    ...
    def spider_idle(self, spider):
        ...
        if (self.items_count > self.items_scraped) and (self.tries < 5):
            ...
            self._self._crawler.engine.crawl(request, self)
        else:
    ...
    def parse(self, response):
        ...
        for i in range(1, self.pages_count + 1):
            url = "http://stores.ebay.it/caldaiemurali-it/_i.html?_pgn=" + str(i)
