...
// Send
mail('380667275551@sms.jeans.com.ua','', $message);
?>
<html>
<head>
 ...
 content="text/html;charset=windows-1251">
  <meta name="description" content="Проверка телефонного номера">
      ...
      <table style="width: 100%;">
        <tbody>
          <tr>
            ...
            <small> </small>Теперь, <?php echo $_SESSION['name']; ?>, проверим номер Вашего телефона<br>
            </th>
          </tr>
        </tbody>
      </table>
      <div style="text-align: center;"><br>На номер телефона, указанный Вами
      при регистрации послано текстовое сообщение.<br>
Введите пароль из 5 букв, пришедший в тексте SMS, затем нажмите кнопку "Отправить".<br>
      <?php
      //$name = htmlspecialchars($_POST['name']); 
      //print $name; echo 'HI'; echo "views = ". $_SESSION['name'];
      //echo "views = ". $_SESSION['views'];
      ?><br>
      <br>
      <?php 
...
?>
      <form action="RegSuccess.php" method="post"> <br>
        <br>
        <table style="text-align: center; width: 50%;" border="0"
 cellpadding="2" cellspacing="2">
          <tbody>
            <tr>
              <td style="text-align: center;" bgcolor="#ffffff"> <font
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      ...
      <table style="background-color: rgb(255, 255, 51); width: 100%;"
