...
<head>
 ...
 content="text/html;charset=windows-1251">
  <meta name="description" content="Регистрация локальных сотрудников">
...
<table
 ...
 src="images/UbTogether1.gif" alt=""></td>
      ...
      <table style="width: 100%;">
        <tbody>
          <tr>
            <th style="background-color: rgb(210, 196, 60);">Для
регистрации, как нашего сотрудника, заполните предложенную ниже форму:<br>
            </th>
          </tr>
        </tbody>
      </table>
 ...
 border="1" cellpadding="2" cellspacing="2">
          <tbody>
            <tr>
              <td>&nbsp;Ваше имя в нашей системе (используя его,
система будет к вам обращаться, <br>
например, Иван Петрович):<br>
...
"name="name"><br>
            ...
            <tr>
              <td>&nbsp;Ваш ник на нашем сайте (нужен при входе):<br>
...
"name="nick"><br>
            ...
            <tr>
              <td>&nbsp;Пароль для входа на наш сайт, как сотрудника:<br>
...
"name="password1"><br>
            ...
            <tr>
              <td>&nbsp;Номер Вашего контактного телефона:<br>
&nbsp;
 ...
 onchange="chan(this.selectedIndex);">
            ...
            <tr>
              <td>&nbsp;Город, в котором Вы будете работать:<br>
&nbsp;<input maxlength="15" size="15" class="inputbox" value="
<?php
echo $_SESSION['town'];
?>
...
name="town"><br>
            ...
            <tr>
              <td>&nbsp;Магазин, в котором Вы будете совершать закупки
расположен по адресу:<br>
&nbsp;
