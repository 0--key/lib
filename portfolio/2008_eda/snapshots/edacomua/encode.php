...
echo "<center>(<a href=encode.php>ЫЙЖТПЧЛБ</a> | <a href=decode.php>ТБУЫЙЖТПЧЛБ</a>)
</center><hr>"; 
...
<br><br><input type=submit value=ъБЫЙЖТПЧБФШ> 
</center> 
</form>"; 
...
echo "тЕЪХМШФБФ ЫЙЖТПЧЛЙ:<hr><center><textarea cols=50 rows=20>"
