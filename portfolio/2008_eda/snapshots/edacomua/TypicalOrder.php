...
<head>
 ...
 content="text/html;charset=windows-1251">
  <meta name="description" content="TypicalOrderForm">
  <meta name="keywords"
 content="e-da.com.ua. Интернет-магазин с доставкой на дом">
...
<table
 ...
 action="http://eda-eda.ru/cart/mass_add/">
        <table class="catalog_list">
          <tbody>
            ...
            <tr id="row77704" class="row22">
              <td>Соусы, майонез, кетчуп.</td>
              <td class="listname"> <a
 href="http://eda-eda.ru/catalog/77704/" class="nobeauty">330ГР КЕТЧУП
ЛЕЧО БАЛТИМОР СТ</a></td>
              <td>35&nbsp;руб.</td>
              <td class="tdcart"><input value="0" name="pcs77704"
 id="pcs77704" maxlength="2" size="2" class="cart_qnt" type="text"><input
 value="catalog" name="tbl77704" type="hidden">шт. <input name="BT_DEC"
 value="-" onclick="decA(document.order.pcs77704)" type="button"> <input
 name="BT_INC" value="+" onclick="incA(document.order.pcs77704)"
 type="button"><input name="CART"
 style="padding: 1px; background: rgb(224, 224, 224) url(/i/cart.gif) no-repeat scroll 3px center; -moz-background-clip: -moz-initial; -moz-background-origin: -moz-initial; -moz-background-inline-policy: -moz-initial; width: 33px; cursor: pointer;"
 value="&nbsp;" onclick="sndReq(77704,document.order.pcs77704.value)"
 type="button"> </td>
            </tr>
          </tbody>
        </table>
...
//$link = mysql_connect('localhost', 'root', ~/.my.cnf)
  //  or die('Could not connect: ' . mysql_error());
//echo 'Connected successfully';
//mysql_select_db('managerie') or die('Could not select database');
