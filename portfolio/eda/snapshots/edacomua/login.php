...
$name = mysql_fetch_array($result);
            echo 'Приветствую тебя, ', $name[0];}
            else echo 'Псевдоним или пароль
введены неправильно!', $nick;
?><br>
            </th>
          </tr>
        </tbody>
      ...
      <?php
      if ($num_rows!=0){
      echo 'Итак, начнём занесение списка доступных товаров.<br>';
 ...
 face=\"Arial\" size=\"2\">Введите штрих-код : </font></td>
 ...
 size=\"13\" maxlength=\"13\" type=\"text\"></td>
        ...
        <small> </small></form>';
        echo '
Введи 13-ти значный штрих-код, указанный на упаковке, затем нажми
клавишу "Проверить". Это позволит избавиться от бесполезного дублирования ввода информации
о товарах даже на первом этапе.<br>';}
?>
      <br>
      <br>
      <br>
Такой товар <big><span style="color: rgb(0, 153, 0);">уже есть</span></big>
в нашей базе данных!<br>
Вернись на предыдущую страницу, и введи штрих-код другого товара.<br>
      <br>
      <br>
      <big><span style="color: rgb(51, 102, 102);">Этот товар заносится
в нашу базу данных впервые!</span></big><br>
Заполни предложенную форму, ориентируясь на подстрочный текст и
соблюдая правила грамматики.<br>
      <big>Пожалуйста, будь внимателен!</big><br>
По окончании нажми на клавишу "Отправить".<br>
      <br>
      <br>
      <big><big>Вернись на предыдущую страницу и повтори процедуру
идентификации.</big></big><br>
      <small> </small></div>
      </td>
    </tr>
  </tbody>
