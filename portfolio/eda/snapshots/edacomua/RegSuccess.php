...
$query = "SELECT * FROM clients WHERE nick = '$nick' ";
...
('$nick', '$password', '1', '$name', '$town', '2', '$phonenum', '$street', '$buildno', '3', '$flat', 'free', '4', 'first')";
mysql_query ("set character_set_client='cp1251'"); 
mysql_query ("set character_set_results='cp1251'"); 
mysql_query ("set collation_connection='cp1251_general_ci'");
$result = mysql_query($query) or die('Query failed: ' . mysql_error());
...
?> <br>
      ...
      //echo '</li>';
        ...
        echo '</ul>
&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; Адрес, по
которому&nbsp; мы будем осуществлять доставку Ваших заказов:<br>
      <ul>
        <li>Город '; echo $town;
      echo '<br>
        </li>
      ...
      echo '</li>';
      if ($korpus!="") { echo '
        <li>Корпус '; echo $korpus; echo '</li>';}
        echo '<li>Квартира '; echo $flat;
      echo '</li>
      </ul>
...
ним и пароль для входа в нашу систему может осуществлять покупки от Вашего
  имени.</big></big><br> Это хорошо с одной стороны:
 Вы можете поручить делать покупки Вашим близким, но с другой стороны, Вам не
  следует разглашать эти данные посторонним людям. Теперь, при каждом Вашем входе
 на наш сайт, вам следует ввести Ваши псевдоним
 и пароль в окошке для входа в левом верхнем углу <br><a href="index.html"><big
...
недоразумений пройдите процедуру регистрации заново указав Ваши новые
...
Если хотите, можете повторить процедуру <a href="ClientRegForm1.html">регистрации</a>
сначала.<br>
