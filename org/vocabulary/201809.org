...
*** --->
  ...
  verb
   1. мучить (torment, torture, excruciate, tantalize, rack, bedevil)
   2. терзать (worry, rankle, maul, drag, prey, bedevil)
   3. околдовать (cast a spell on, cast a spell over, witch, bedevil, cast a glamor over, cast a spell upon)
   4. наводить порчу (bedevil)
   5. путать (muddle, muss, bumble, ball up, muddle up, bedevil)
   6. сбивать с толку (confuse, bewilder, baffle, mislead, perplex, bedevil)
   7. изводить (harass, torment, badger, nag, harry, bedevil)
...
*** --->
  ...
  adverb
   1. неблагоприятно (adversely, disadvantageously, ill, illy)
   2. враждебно (with hostility, hostilely, adversely, with animosity, with enmity)
...
*** --->
  ...
  adverb
   1. исключительно (exclusively, exceptionally, exclusive, only, solely, entirely)
...
*** --->
  ...
  noun
   1. тоска (yearning, anguish, melancholy, depression, longing for, wistfulness)
   2. боль (pain, hurt, ache, anguish, distress, complaint)
   3. мучение (torment, anguish, misery, fret, worry, fash)
   4. страдание (suffering, misery, pain, distress, anguish, heartache)
   5. мука (flour, meal, throe, martyrdom, torment, anguish)

  verb
   1. испытывать острую тоску (anguish)
...
*** --->
  ...
  verb
   1. поддаваться (succumb, yield, give way, fall for, surrender, take)
   2. уступить (succumb, give up, step back, knuckle down, knuckle under)
   3. умереть (die, kick, kick in, pass away, snuff, succumb)
   4. стать жертвой (fall a victim to, succumb, be victimized by)
...
*** --->
  ...
  noun
   1. взгляд в прошлое (hindsight, flashback, retrospect)
   2. непредусмотрительность (hindsight, improvidence)
   3. прицел (aim, sight, rear sight, bead, backsight, hindsight)
...
*** --->
  ...
  noun
   1. глупость (stupidity, folly, foolishness, silliness, absurdity, imbecility)
   2. безумие (madness, insanity, frenzy, folly, lunacy, distraction)
   3. безрассудство (recklessness, folly, desperation, temerity, foolishness, rashness)
   4. дурь (folly)
   5. безумство (madness, folly, desperation)
   6. дурость (folly)
   7. недомыслие (thoughtlessness, folly, stupidity)
   8. глупый поступок (folly, foolery, lunacy)
   9. безрассудное поведение (folly)
  10. дорогостоящий каприз (folly)
  ...
  Colin Camerer, a professor of behavioral economics at Caltech and
  leading speaker and researcher on the intersection of game theory
  and neuroscience, explained to me the practical folly of imagining
  that we could just get our deliberative minds to do more of the
...
*** --->
  ...
  verb
   1. пожирать (devour, gobble, consume, eat up, eat away, guzzle)
   2. поглощать (absorb, swallow, devour, consume, adsorb, eat)
   3. лопать (devour)
   4. истреблять (destroy, exterminate, consume, decimate, devour, annihilate)
   5. уничтожать (destroy, consume, kill, demolish, annihilate, devour)
   6. проглатывать (swallow, ingest, devour, get down, take down, engorge)
   7. есть с жадностью (gorge, raven, tuck into, guzzle, devour, gobble)
  ...
  standing around on the savanna, debating the origin of a potentially
  threatening sound while its source devoured us.
* flout                                                                :Duke:
...
*** --->
  ...
  verb
   1. попирать (trample, violate, tread down, trample on, flout, override)
   2. пренебрегать (neglect, flout, ignore, disregard, disdain, defy)
   3. презирать (despise, scorn, look down, disdain, flout, contemn)
   4. глумиться (mock, scoff, sneer, jeer, flout)
   5. издеваться (scoff, mock, flout, ride, guy, roast)
   6. насмехаться (mock, taunt, scoff, sneer, razz, flout)

  noun
   1. пренебрежение (neglect, disregard, disdain, scorn, slight, flout)
   2. насмешка (mockery, ridicule, sneer, taunt, mock, flout)
   3. издевательство (mockery, flout)
...
*** --->
  ...
  adverb
   1. неправильно (wrong, improperly, amiss, unduly, awry, fallaciously)
   2. набок (awry)
   3. неудачно (poorly, abortively, awry)
   4. косо (obliquely, askance, askew, slantwise, aslant, awry)
   5. нехорошо (bad, badly, awry)

  adjective
   1. кривой (crooked, wry, awry, askew, bent, bandy)
   2. неправильный (wrong, incorrect, improper, irregular, abnormal, awry)
   3. искаженный (distorted, perverted, misrepresented, warped, mutilated, awry)
...
*** --->
  ...
  adverb
   1. кратко (briefly, short, succinctly, tersely)
   2. сжато (succinctly, briefly, shortly, compendiously)
