...
For beginners this means a wobbly dance
between full focus and a wandering mind.
* frenetic :Goleman:
...
Actually, the sense of a torrent of
...
successively subtle feelings of bliss and rapture, and stronger equanimity, along
with an increasingly firm and effortless focus.
* ado :EWW:
...
As a lifelong night owl, my
stability tends to be much more under control, much more
even keel when I go to bed by 11:00 p.m.
* woe :EWW:
...
I should also update this because
noting that I, in the last few weeks, have been
experimenting with something that he produces called the
Yin Reserve, which includes several different components
that he alludes to in this conversation.
* adhesions :EWW:
...
There’s a lot of stuff out there that exists to get rid
of adhesions and improve range of motion.
* contestants :EWW:
...
Tim Ferriss: It’s somewhat contraindicated for
contestants in fat adaption.
* chagrin :EWW:
...
Tim Ferriss: That’s why you didn’t flinch when we were
talking about Jocko Willink, the SEAL Commander.
* supposedly :EWW:
...
The air
pressure chambers that supposedly flush out lactic acid.
* exaggeration :EWW:
...
Tim Ferriss: Are you a proponent of ice, ice baths, or
...
You’re so tired at that point, and so
delirious, that I guess I didn’t even realize the import
of that situation.
* uncanny :EWW:
...
Mike Birbiglia: He has this really uncanny skill of
talking in circles and slow and circling back to the
first topic and then the next topic and then another
thing and then a digression.
* semblance :EWW:
...
I wonder if it makes the value of the
rituals even greater if you are able to maintain some
semblance of a routine when touring?
* irksome :EWW:
...
I think that there’s a cultural thing right now that it
is kind of irksome, which is that people feel like – I
read it recently in The New York Times, where someone
said, I’m forgetting her name who wrote this, but she
said “If I had advice for college students, it would be
...
Though strong
concentration can be an enormous aid along the way, the
Buddha’s path veers into a different kind of inner
focus: the path of insight.
* stance :EWW:
...
Once we banish these from our minds, we can take up the
ONE Thing with an open mind and a clear path.
