...
*** --->                                                              :drill:
  ...
  to a [novice]; they are able to discern patterns at a glance that are
  anything but obvious to an untrained eye; they see details as part
  of a whole and know at once what is crucial and what is incidental.
* incongruity :Holmes:
