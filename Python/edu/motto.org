...
***** quantifiers
** Pronounce
*** listen and [[http://www.manythings.org/listen/][read]] alone
** Vocabulary
...
*** [#B] http://orgmode.org/worg/org-contrib/babel/languages/ob-doc-python.html
** TODO New shortcuts
   C-x Left/Right
   M-x $
   M-x ispell
   ...
   C-h b, d, k, v(ariable)
   M-x eval-buffer
*** trivial embedding into main text:
